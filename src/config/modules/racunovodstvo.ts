  ...
  fields: [
    {
      ...
      explainer:
        'Vse listine vseh strank skupaj. Ocena: 60 strank × 80 listin ≈ 4.800 listin na mesec.',
    },
    {
      ...
      explainer:
        'Vzemite en teden in preštejte, koliko listin je nekdo vnašal ročno. Primer: od 1.200 listin je ' +
        '500 ročnih → približno 40 %.',
    },
    {
      ...
      explainer:
        'Od prejema listine do knjižene postavke: odpiranje, branje, vnos, kontiranje. Izmerite na ' +
        'desetih listinah — običajno 3 minute pri skeniranem računu, 6 pri papirnem.',
    },
    {
      ...
      explainer:
        'Isti podatek, vpisan drugič: iz enega programa v drugega, iz Excela v knjigovodstvo. Ocena: 2 ' +
        'osebi × 3 h na teden ≈ 26 ur na mesec.',
    },
    {
...
export const strankeRs: ModuleDefinition = {
  ...
  fields: [
    ...
    },
    {
      ...
      explainer:
        'Ure za lovljenje manjkajočih listin in pojasnil: klici, e-pošta, opomniki strankam. Ocena: 15 ' +
        'strank × 30 min ≈ 8 ur na mesec.',
    },
    {
      ...
      explainer: 'Delež strank, ki listine redno odda po dogovorjenem roku; groba ocena zadostuje.',
    },
    {
      key: 'deliveryMethod',
...
export const obracuniRs: ModuleDefinition = {
  ...
  fields: [
    ...
    },
    {
      ...
      explainer:
        'Ure za obračune in poročila strank: DDV, plače, medletna poročila, priprava za oddajo. Ocena: 2 ' +
        'osebi × 8 h ob koncu meseca ≈ 16 ur.',
    },
    {
    ...
    },
    {
      ...
      explainer:
        'Samo posledice zamude pri oddaji: globe, zamudne obresti, doplačila za nujno urejanje. Če jih ni ' +
        'bilo, vpišite 0.',
    },
    {
      key: 'closingProcess',
...
export const popravkiRs: ModuleDefinition = {
  ...
  fields: [
    ...
    },
    {
      ...
      explainer:
        'Kontrole, ki jih delate samo zato, ker podatkom ne morete zaupati — ne reden strokovni pregled. ' +
        'Ocena: vodja 3 h na teden ≈ 13 ur na mesec.',
    },
    {
      ...
      explainer:
        ...
        'davek; seštevek zadnjih 12 mesecev.',
    },
    {
  ...
  fields: [
    {
      ...
      explainer:
        'Ure za stranko, ki nikoli ne pridejo na račun: dodatna vprašanja, svetovanje, urejanje nereda ' +
        'pred obračunom. Ocena: 40 strank × 1 h ≈ 40 ur na mesec.',
    },
    {
    ...
    },
    {
      ...
      explainer:
        'Kar stranka plača, minus vaše ure × strošek ure. Primer: plača 150 EUR, porabite 12 ur × 26 EUR ' +
        '= 312 EUR → primanjkljaj 162 EUR.',
    },
    {
      /**
      ...
      explainer:
        'Skupne mesečne ure vseh zaposlenih delite s številom strank. Primer: 600 ur / 60 strank = 10 ur ' +
        'na stranko.',
    },
    {
      ...
      explainer:
        'Koliko strank ste zavrnili ali odsvetovali, ker niste imeli kapacitete; groba ocena zadostuje.',
    },
